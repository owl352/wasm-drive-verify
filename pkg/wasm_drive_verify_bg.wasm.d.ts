...
export const verifyidentitykeysbyidentityidresult_not_found_public_keys: (a: number, b: number) => void;
...
export const verifyVotePollVoteStateProof: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => void;
...
export const verifyfullidentitybyuniquepublickeyhashresult_identity: (a: number, b: number) => void;
export const verifyfullidentitybyuniquepublickeyhashresult_root_hash: (a: number) => number;
export const verifyfullidentitybyidentityidresult_identity: (a: number, b: number) => void;
...
export const verifycontractresult_contract: (a: number, b: number) => void;
